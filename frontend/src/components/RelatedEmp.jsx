...
const RelatedEmp = ({speciality, empId}) => {
  ...
  return (
    <div className='flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10'>
      ...
      <button onClick={()=>{ navigate('/employees'); scrollTo(0,0) }} className='bg-gradient-to-r from-primary to-emerald-500 text-white px-12 py-3 rounded-full mt-10 hover:scale-105 transition-all duration-300'>more</button>
    </div>
  )
}
