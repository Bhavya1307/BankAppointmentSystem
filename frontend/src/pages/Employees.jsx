    ...
    <div>
      ...
      <div className='flex flex-col sm:flex-row items-start gap-5 mt-5'>
        ...
        <div className={`flex-col gap-4 text-sm text-gray-600 ${showFilter ? 'flex' : 'hidden sm:flex'}`}>
          ...
          <p onClick={()=> speciality === 'Savings and Checking Accounts' ? navigate('/employees') : navigate('/employees/Savings and Checking Accounts')} className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all duration-500 cursor-pointer ${speciality === "Savings and Checking Accounts" ? "bg-green-50 text-black" : ""}`}>Savings & Checking Accounts</p>
